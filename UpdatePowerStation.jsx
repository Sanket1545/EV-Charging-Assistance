...
export default class UpdatePowerStation extends Component {
    constructor(props) {
        super(props)
        ...
        this.updatePowerstation = this.updatePowerstation.bind(this);
      ...
      componentDidMount()
      {
          ...
          PowerStationService.getPowerstationById(this.state.stationid).then((res) =>{
            let powerstation = res.data;
            this.setState({name : powerstation.name,
            email : powerstation.email,
            password : powerstation.password,
            mobileno : powerstation.mobileno,
            location : powerstation.location,
            area : powerstation.area,
            city : powerstation.city,
            portid : powerstation.portid
            });
          });
      }
                  ...
                  <div className='container'>
                      <div className='row'>
                          <div className='card col-md-6 offset-md-3 offset-md-3'>
                              <h3 className='text-center'>Update Charging Station</h3>
                              <div className='card-body'>
                                  <form>
                                      ...
                                      <button className='btn btn-success' onClick={this.updatePowerstation}>Update</button>
